...
export const Route = createFileRoute("/auth")({
  head: () => ({ meta: [{ title: "Entrar — BM Monteiro" }] }),
  component: AuthPage,
});
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl">BM Monteiro</CardTitle>
          <CardDescription>Acesse para gerenciar as vendas</CardDescription>
        </CardHeader>
          ...
          <Tabs defaultValue="signin">
            ...
            <TabsContent value="signup">
              <form onSubmit={signUp} className="space-y-3 pt-3">
                ...
                <p className="text-xs text-muted-foreground text-center">O primeiro cadastro vira administrador.</p>
              </form>
            </TabsContent>
          </Tabs>
        </CardContent>
